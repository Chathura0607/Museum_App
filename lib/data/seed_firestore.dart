...
final List<Artifact> _initialArtifacts = [
  ...
  Artifact(
    ...
    details: 'The gladius was the primary sword of Ancient Roman foot soldiers from the 3rd century BC until the 4th century AD. This specific design, the "Mainz" type, was used primarily on the frontiers of the Empire. It was a short, double-edged sword designed for thrusting in the close-quarters environment of the Roman legionary phalanx.',
    detailsSi: 'ග්ලැඩියස් යනු ක්‍රි.පූ. 3 වන සියවසේ සිට ක්‍රි.ව. 4 වන සියවස දක්වා පුරාණ රෝම පාබල සොල්දාදුවන්ගේ ප්‍රධාන කඩුව විය. මෙම සැලසුම අධිරාජ්‍යයේ දේශසීමා වල ප්‍රධාන වශයෙන් භාවිතා කරන ලදී.',
  ...
  Artifact(
    ...
    details: 'The Rosetta Stone is a granodiorite stele, found in 1799, inscribed with three versions of a decree issued at Memphis, Egypt, in 196 BC. The stone provided the key to the modern understanding of Egyptian hieroglyphs.',
    detailsSi: 'රොසෙටා ගල යනු ක්‍රි.පූ. 196 දී ඊජිප්තුවේ මෙම්ෆිස් හි නිකුත් කරන ලද ආඥාවක සංස්කරණ තුනක් කොටා ඇති ගලකි. මෙමගින් පුරාණ ඊජිප්තු අක්ෂර කියවීමට මග පෑදුනි.',
  ...
  Artifact(
    ...
    details: 'The Aphrodite of Milos, better known as the Venus de Milo, is an ancient Greek statue and one of the most famous works of ancient Greek sculpture. Created during the Hellenistic period, it was discovered on the island of Milos in 1820.',
    detailsSi: 'වීනස් ද මයිලෝ යනු ලොව ප්‍රසිද්ධම පුරාණ ග්‍රීක ප්‍රතිමා වලින් එකකි. ක්‍රි.පූ. 150 ත් 125 ත් අතර කාලය තුළ නිර්මාණය කරන ලද මෙය 1820 දී මයිලෝස් දූපතේදී සොයා ගන්නා ලදී.',
  ...
  Artifact(
    id: 'artifact_005',
    name: 'Lewis Chessmen',
    nameSi: 'ලුවිස් චෙස් ක්‍රීඩකයෝ',
    descriptionSi: 'වොල්රස් ඇත්දළවලින් නෙළන ලද චෙස් ඉත්තෝ.',
    period: '12th Century',
    section: 'Viking Age',
    description: 'Iconic gaming pieces made of walrus ivory.',
    details: 'The Lewis Chessmen are a group of distinctive 12th-century chess pieces discovered in 1831 on the Isle of Lewis in Scotland. They are famous for their expressive faces.',
    detailsSi: 'ලුවිස් චෙස් ක්‍රීඩකයෝ යනු ස්කොට්ලන්තයේ ලුවිස් දූපතෙන් සොයාගත් 12 වන සියවසේ චෙස් ඉත්තන් කණ්ඩායමකි.',
  ...
  Artifact(
    ...
    descriptionSi: 'පළමු මිනිසුන් සඳ මතට රැගෙන ගිය අභ්‍යවකාශ යානය.',
    period: '1969 AD',
    section: 'Modern History',
    description: 'The spacecraft that carried the first men to the Moon.',
    details: 'The Command Module "Columbia" was the spacecraft that served as the command center for the three-person crew during the Apollo 11 mission—the first mission to land humans on the Moon.',
    detailsSi: 'ඇපලෝ 11 විධාන මොඩියුලය යනු පළමු වරට මිනිසුන් සඳ මතට ගොඩබැස්සවූ ඓතිහාසික අභ්‍යවකාශ යානයයි.',
...
Future<void> seedFirestore() async {
  ...
  await batch.commit();
  print('Seeding complete: Collection updated with stable YouTube IDs!');
}
